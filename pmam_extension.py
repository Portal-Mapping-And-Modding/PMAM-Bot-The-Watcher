...
class Test(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if "https://steamcommunity.com/sharedfiles" in message.content and "steam://openurl/" not in message.content and message.channel.id in [922653836626243654,941813875538538627]:
            ...
            await thread.send(f"Here is a link that will directly open Steam: https://electrovoyage.github.io/{message.content[message.content.find('https://steamcommunity.com/sharedfiles'):message.content.find('https://steamcommunity.com/sharedfiles')+65]}")
    @commands.Cog.listener()
